...
# ── 7. Summary ────────────────────────────────────────────────────────
message(STATUS "┌─── Toolchain Detection ───────────────────────────")
message(STATUS "│ Compiler:    ${CMAKE_CXX_COMPILER_ID} ${COMPILER_VERSION}")
message(STATUS "│ Platform:    ${CMAKE_SYSTEM_NAME} (${HOST_ARCH}, ${HOST_BITS}-bit)")
message(STATUS "│")
message(STATUS "│ COMPILER_MSVC:        ${COMPILER_MSVC}")
message(STATUS "│ COMPILER_CLANG:       ${COMPILER_CLANG}")
message(STATUS "│ COMPILER_APPLE_CLANG: ${COMPILER_APPLE_CLANG}")
message(STATUS "│ COMPILER_GCC:         ${COMPILER_GCC}")
message(STATUS "│ COMPILER_INTEL_LLVM:  ${COMPILER_INTEL_LLVM}")
message(STATUS "│")
message(STATUS "│ CLANG (alias):        ${CLANG}")
message(STATUS "│ GCC   (alias):        ${GCC}")
message(STATUS "│")
message(STATUS "│ CLANG_CL:             ${CLANG_CL}")
message(STATUS "│ CLANG_MINGW:          ${CLANG_MINGW}")
message(STATUS "│ CLANG_CYGWIN:         ${CLANG_CYGWIN}")
message(STATUS "│ CLANG_GNU:            ${CLANG_GNU}")
message(STATUS "└───────────────────────────────────────────────────")